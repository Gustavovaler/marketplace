<template>
    <div>
        <div class="container mt-2">
            ...
            <div class="row">
               <!-- LEFT COLUMN -->
                <div class="col-md-9" id="center_content"> 
                    <!-- TITLE ROW -->
                    <div class="row-md-12 title mb-2">
                        <h2>{{name}}</h2>
                    </div>
                    <!-- TOP CONTENT ROW -->
                    <div class="row content-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <span class="badge badge-secondary">Vistas </span> <span class="quantity-box"> {{vistas}}</span> 
                             <hr>
                            <span class="alert alert-danger" v-if="disponibility > 0"> Disponible para retirar en {{disponibility}} dias</span> <span class="alert alert-success" v-else>Disponible para retirar en el acto.</span>
                        </div>
                    </div>
                    <!-- MIDDLE CONTENT ROW -->
                    <div class="row content-row">
                ...
                <div class="col-md-3" id="aside">
                    <div class="row">
                        ...
                        <div class="col pt-3 text-center">
                            <h2 >Tuyo por solo:</h2>
                            <h1 class="price bg-success text-white">$ {{price}}</h1>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col pt-3 text-center">
                            <p><b>Nombre: </b>{{seller_data.nombres}}</p>
                            <p><b>Apellido: </b>{{seller_data.apellidos}}</p>
                            <p><b>Telefono: </b>{{seller_data.telefono}}</p>
                            <p><b>Provincia: </b>{{provincia}}</p>
                            <p><b>Ciudad: </b>{{localidad}}</p>
                            <div class="comprar">
...
export default {
    props:[ 'name', 'description', 'quantity', 
            ...
            'marca', 'categoria', 'vistas', 'disponibility'],
    data(){
        return{
...
.guarda{
    min-height: 6px;
    width: 100%;
    background-color:rgb(211, 72, 8) ;
}
.title{
    /* background-color: rgb(216, 236, 245); */
    background: rgb(211, 72, 8);
    color: snow;
    padding: .2rem .7rem;
    border-radius: 4px;
}
...
.img-center:hover{
    ...
    box-shadow: 1px 2px 2px rgba(5, 247, 222, 0.4);
}
/* .content-row{
